...
%============================ Title details =================================%
\def\title{TITLE}
\def\englishtitle{Upper Confidence Bound Algorithm to Recommend ArXiv Scientific Research Paper}
\def\author{Emmanuel Krishnandito Laksana}
\def\nim{225314024}
...
\begin{titlepage}
	\begin{center}
		\large
		\textbf{\MakeUppercase{\Algoritma Upper Confidence Bound pada Rekomendasi Karya Ilmiah ArXiv.org}}
		\vspace{2ex}
